            ...
            <div class="faq-container">
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-getting_started-content hidden" id="faq-getting_started-content">
                        ...
                        <li style="cursor: pointer; font-size: 22px;" onclick="toggleContent('answer1')"> 
                            How do I sign up?
                            ...
                            <li  style="cursor: pointer; font-size: 22px;" onclick="toggleContent('answer2')"> What are the requirements to register?
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-account-content hidden" id="faq-account-content">
                        <ul>
                            <li  onclick="toggleContent('answer3')"> How do I update my profile or payment information?
                            ...
                            <li  onclick="toggleContent('answer4')"> Are there membership tiers or loyalty programs?
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-booking-content hidden" id="faq-booking-content">
                        <ul>        
                            <li  onclick="toggleContent('answer5')"> How do I book a car?
                            ...
                            <li  onclick="toggleContent('answer6')"> Can I modify or cancel my booking?
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-payment-content hidden" id="faq-payment-content">
                        <ul>
                            ...
                            <li  onclick="toggleContent('answer7')"> How does the pricing work?
                            ...
                            <li  onclick="toggleContent('answer8')"> How do I retrieve my payment receipts?
                            ...
                            <li  onclick="toggleContent('answer9')"> What payment methods are accepted?
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-locations-content hidden" id="faq-locations-content">
                        <ul>
                            <li  onclick="toggleContent('answer10')"> Where can I pick up or drop off the cars?
                            ...
                            <li  onclick="toggleContent('answer11')"> Are cars available 24/7?
                                <div class="hidden" id="answer11">Absolutely! Our platform and car fleet are accessible 24/7 for your convenience.</div><br>
                            </li>
                            <li  onclick="toggleContent('answer12')"> What if I am unable to find a car near me?
                ...
                <div class="faq-body">
                    ...
                    <div class="faq-vehicle-content hidden" id="faq-vehicle-content">
                        <ul>
                            <li  onclick="toggleContent('answer12')"> What if the vehicle has damage or is dirty when I start my trip?
                                <div class="hidden" id="answer12">Before starting your journey, inspect the car. If you find damages or cleanliness issues, snap a photo and email it to us. We'll guide you on the next steps, ensuring you have a pleasant experience. Refunds or adjustments will be made if necessary.</div><br>
                            </li>
                            <li  onclick="toggleContent('answer12')"> How does fueling or charging work?
                                <div class="hidden" id="answer12">Fuel and charging expenses are on us! Every car is equipped with a cash card for fuel and charging station payment</div>
                            </li>
                        </ul>
                    </div>
                </div>
