                        ...
                        <div class="faq-getting_started-content hidden" id="faq-getting_started-content">
                            <ul>
                                <li class="faq-list" onclick="toggleContent('answer1')">
                                    How do I sign up?
                                    <div class="hidden" id="answer1"><br>Simply click on the 'Sign Up' option in the navigation bar at the top. Follow the prompts to provide necessary details like your name, IC, email, and more.</div><br>
                                </li>
                                <li class="faq-list" onclick="toggleContent('answer2')"> What are the requirements to register?
                                    <div class="hidden" id="answer2"><br>You'll need a valid Class 3 or 3A driving license.</div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="faq-account-content  hidden" id="faq-account-content">
                        <ul>
                            ...
                            <li class="faq-list" onclick="toggleContent('answer4')"> Are there membership tiers or loyalty programs?
                                <div class="hidden" id="answer4"><br>Currently, we don't offer membership tiers or loyalty programs. Stay tuned for future updates!</div>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="faq-booking-content  hidden" id="faq-booking-content">
                        <ul>
                            ...
                            <li class="faq-list" onclick="toggleContent('answer6')"> Can I modify or cancel my booking?
                                <div class="hidden" id="answer6"><br>Yes, you can modify or cancel your booking up to 1 hour before your scheduled start time. Cancellations made later than this will incur a $20 penalty.</div>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="faq-locations-content  hidden" id="faq-locations-content">
                        <ul>
                            ...
                            <li class="faq-list" onclick="toggleContent('answer11')"> Are cars available 24/7?
                                <div class="hidden" id="answer11"><br>Absolutely! Our platform and car fleet are accessible 24/7 for your convenience.</div><br>
                            </li>
                            <li class="faq-list" onclick="toggleContent('answer12')"> What if I am unable to find a car near me?
                                <div class="hidden" id="answer12"><br>You can submit a location request form on our site. We evaluate these requests for potential new locations. In the meantime, only the locations listed on our site are available.</div>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="faq-vehicle-content  hidden" id="faq-vehicle-content">
                        <ul>
                            ...
                            <li class="faq-list" onclick="toggleContent('answer14')"> How does fueling or charging work?
                                <div class="hidden" id="answer14"><br>Fuel and charging expenses are on us! Every car is equipped with a cash card for fuel and charging station payment</div>
                            </li>
                        </ul>
                    </div>
                </div>
